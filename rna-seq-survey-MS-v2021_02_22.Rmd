...
kable(Total_read_counts %>%
        select(-variance), digits = 1)

kable(Total_read_counts %>%
        select(-variance), digits = 0)
...
# samples with fewer than 10% mend reads
n_datasets_above_31_Total_reads_and_fewer_than_10_pct_MEND <- counts_and_meta %>%
  filter(MEND/Total_reads < 0.1 & Total_reads>31E6) %>%
  nrow

n_datasets_above_31_Total_reads
n_datasets_above_31_Total_reads_and_fewer_than_10_pct_MEND


n_datasets_above_31_Total_reads_and_fewer_than_10_pct_MEND/n_datasets_above_31_Total_reads
