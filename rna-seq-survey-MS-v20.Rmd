...
write_tsv(repo_table, "Table_S2_repo_table.tsv")
...
write_tsv(cohort_table, "Table_S3_cohort_table.tsv")

# snakecase::to_any_case("cohort_code", case = "title")
cohort_table %>% 
...
## Overview
```{r rna-seq-survey-MS-v19-17}
comparison_of_distributions
```


## unmapped
```{r rna-seq-survey-MS-v19-18 }
...
```{r rna-seq-survey-MS-v19-23, fig.height=2, fig.width=6}
...
```{r rna-seq-survey-MS-v19-25, fig.height=4, fig.width=8}
...
# Figure 1
```{r rna-seq-survey-MS-v19-26, fig.height=6, fig.width=10}
...
# Plot read fractions
```{r rna-seq-survey-MS-v19-28, fig.height=4.5, fig.width=8.25}
...
```{r rna-seq-survey-MS-v19-30, fig.height=6, fig.width=8}
...
```{r rna-seq-survey-MS-v19-31 }

read_type_names <- c("Total_reads", "Mapped",  "MND", "MEND")

```

```{r rna-seq-survey-MS-v19-32 }
...
## other
```{r rna-seq-survey-MS-v19-34, fig.height=6, fig.width=8}
...
# Figure 2
```{r rna-seq-survey-MS-v19-44, fig.height=8, fig.width=10}
